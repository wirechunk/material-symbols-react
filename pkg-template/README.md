# [@wirechunk/material-symbols-react-{{weight}}](https://github.com/wirechunk/material-symbols-react/tree/main/svg/{{weight}})
...
```sh
npm install @wirechunk/material-symbols-react-{{weight}}@latest
```

The package `@wirechunk/material-symbols-react-{{weight}}` includes only SVGs with weight {{weight}}. To use a different weight, replace `{{weight}}` in the package name with the desired weight.
...
```
@wirechunk/material-symbols-react-{{weight}}/{optical size}/{style}/{icon}.tsx
@wirechunk/material-symbols-react-{{weight}}/{optical size}/{style}/{icon}-fill.tsx
```

Optical sizes can be 20, 24, or 48.

For example, SVGs for the `face` icon with weight {{weight}} and optical size 20 are located at:

```
@wirechunk/material-symbols-react-{{weight}}/20/outlined/face.tsx
@wirechunk/material-symbols-react-{{weight}}/20/outlined/face-fill.tsx
@wirechunk/material-symbols-react-{{weight}}/20/rounded/face.tsx
@wirechunk/material-symbols-react-{{weight}}/20/rounded/face-fill.tsx
@wirechunk/material-symbols-react-{{weight}}/20/sharp/face.tsx
@wirechunk/material-symbols-react-{{weight}}/20/sharp/face-fill.tsx
```

```js
import { Face } from '@wirechunk/material-symbols-react-{{weight}}/20/outlined/face';
...
[license]: https://github.com/wirechunk/material-symbols-react/blob/main/svg/{{weight}}/LICENSE
