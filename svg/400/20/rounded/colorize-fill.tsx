...
export const SvgColorizeFill = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M144-180v-112q0-14.22 5-27.11Q154-332 165-343l321-321-54-53 51-51 72 72 110.22-110.22q4.45-4.45 11.11-7.11Q683-816 691-816t15 2.5q7 2.5 12 7.5l87 88q4.55 5.83 7.27 12.64 2.73 6.8 2.73 14.58t-2.66 14.44q-2.67 6.66-7.11 11.1L696-556l72 73-51 51-54-54-320 321q-11 11-23.89 16T292-144H180q-15.3 0-25.65-10.35Q144-164.7 144-180Zm72-32h76l320-320-75-76-321 320v76Z" />
  </svg>
);
