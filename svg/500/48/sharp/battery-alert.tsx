...
export const SvgBatteryAlert = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path d="M272.59-74.02v-748.2h123.34v-64h168.14v64h123.34v748.2H272.59Zm68.37-68.13h278.08v-611.7H340.96v611.7Zm0 0h278.08-278.08Zm105.93-259.18h66.46v-246.45h-66.46v246.45Zm33.49 152.87q13.82 0 23.39-9.83 9.58-9.84 9.58-23.66t-9.7-23.39q-9.7-9.57-23.77-9.57-13.31 0-23.15 9.7-9.84 9.69-9.84 23.76 0 13.32 9.84 23.16 9.84 9.83 23.65 9.83Z" />
  </svg>
);
